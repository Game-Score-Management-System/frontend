...
export default function OwnRankingPositionCard() {
  return (
    <div className=" relative flex flex-col md:flex-row gap-6 md:gap-20 items-center justify-between p-6 md:p-12 pb-8 overflow-hidden transition-all border-3 rounded-lg border-white/80 bg-black/80 group-hover:border-white w-full">
      ...
      <small className="absolute left-0 right-0 block w-full font-bold text-center uppercase top-2">Tus resultados</small>

      <div className="z-10 flex flex-col items-center justify-center">
        <Image
          isBlurred
          isZoomed
          src='https://robohash.org/21'
          alt='User'
          className="md:w-24 md:h-24 object-cover"
        >
        </Image>
        <p className="mt-3">@Juan1234</p>
      </div>
      <div className="z-10 flex flex-col items-center justify-center text-xl md:text-3xl">
        <strong className="text-4xl md:text-6xl text-green-300">400</strong>
        <strong className="text-base md:text-lg font-light uppercase opacity-70">Puntos</strong>
      </div>
      <div className="z-10 flex flex-col items-center justify-center text-xl md:text-3xl">
        <strong className="text-4xl md:text-6xl text-[#50b9e2]">20º</strong><strong className="text-base md:text-lg font-light uppercase opacity-70">Posición</strong>
      </div>
    </div>
  )
}